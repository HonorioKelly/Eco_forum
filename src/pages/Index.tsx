...
import { Button } from "@/components/ui/button"; // Botão estilizado (shadc/ui)
import { AirVent, ThermometerSun, CloudRain, ArrowRight } from "lucide-react"; //ícone
import { useAuth } from "@/context/AuthContext"; // Hook personalizado de autenticação
...
const Index = () => {
  ...
  // Dados para exibição
  const features = [ // Array com funcionalidade do sistema.
    {
      icon: AirVent,
  ...
  const testimonials = [ //Depoimentos de usuários satisfeitos. 
    {
  ...
  return (
    <div className="flex flex-col min-h-screen">
          ...
          <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
            <div className="flex flex-col justify-center space-y-4">
              ...
              <div className="flex flex-col gap-2 min-[400px]:flex-row">
                {/* Topo da Pagina*/}
                {/* O usuario estiver logado, vai para o Dashboard. se não redireciona para o Registro*/}
                <Button 
                  size="lg" 
      ...
      {/* Registro ou acessarem o sistema */}
